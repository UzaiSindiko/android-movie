    ...
    return (
        <View  style={{ flex: 1, alignItems: 'center', marginBottom: 10, position: 'relative' }}>
                <View style={{ width: '100%', height: 50, position: 'absolute', marginTop: 30, zIndex: 2, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }} >
                    <TouchableOpacity onPress={() =>  navigation.navigate('Movies')} style={{ width: 50, height: 50, borderRadius: 25, backgroundColor: '#ffffff50', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ width: screenWidth}} >
                    ...
                    />
                    <TouchableOpacity  onPress={() => navigation.navigate('TrailerMovie', {id: navigation.state.params.id})}  style={{ width: '100%', height: 200, position: 'absolute', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View  style={{ width: '100%', height: '100%', flexDirection: 'row', marginLeft: '40%' }}>
                        <View style={{ width: '80%', height: '100%'}} >
                            ...
                            <Text style={{ fontWeight: '700', color: '#FFBC03' }}>
                                { starGen(data.movie.popularity) + ` ${data.movie.popularity}` } 
                            </Text>
                        </View>
